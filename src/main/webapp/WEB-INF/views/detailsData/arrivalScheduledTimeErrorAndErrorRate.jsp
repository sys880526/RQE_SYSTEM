                ...
                <div class="contents" width=100%>
                	...
                	<div class="search">
                        <form id="search-bmt">
                            ...
                            <a href="javascript:arrivalScheduledTimeErrorAndErrorRate()" class="btnSearch">
                	...
                	<div class="row" style="margin-bottom: 25px">
                    	...
                    	<table id="tbl-arrival-error-info" style="border-style: none;">
                            <thead>
                                ...
                                <tr>
                                    <th rowspan="3" style="background-color: #f2e6d9;">평가 대상</th>
                                    <th colspan="4" style="background-color: #f2e6d9;">정상주행</th>
                                </tr>
                                <tr>
                                	<th style="background-color: #f2e6d9;">구간</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차 평균</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차 최대</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차 표준오차</th>
                                </tr>
                                <tr>
                                	<th style="background-color: #f2e6d9;">(단위 : 개 )</th>
                                	<th style="background-color: #f2e6d9;">(단위 : 분)</th>
                                	<th style="background-color: #f2e6d9;">(단위 : 분)</th>
                                	<th style="background-color: #f2e6d9;">(단위 : 분)</th>
                                </tr>
                            </thead>
                	...
                	<div class="row" style="margin-bottom: 25px">
                    	...
                    	<table id="tbl-arrival-errorRate-info" style="border-style: none;">
                            <thead>
                                ...
                                <tr>
                                	<th style="background-color: #f2e6d9;">구간</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차율 평균</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차율 최대</th>
                                	<th style="background-color: #f2e6d9;">ETA 오차율 표준오차</th>
                                </tr>
                                <tr>
                                	<th style="background-color: #f2e6d9;">(단위 : 개 )</th>
                                	<th style="background-color: #f2e6d9;">(단위 : %)</th>
                                	<th style="background-color: #f2e6d9;">(단위 : %)</th>
                                	<th style="background-color: #f2e6d9;">(단위 : %)</th>
                                </tr>
                            </thead>
